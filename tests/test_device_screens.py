...
class DeviceScreensOffscreenTest(unittest.TestCase):
    ...
    def test_pdu_updates_statuses_and_preserves_all_commands(self):
        ...
        self.assertEqual("—", screen.info_labels["firmware"].text())
        self.assertEqual(
            "success",
    ...
    def test_pdu_firmware_row_visibility_tracks_model_authority(self):
        ...
        self.assertFalse(screen.info_rows["firmware"].isHidden())
        self.assertTrue(screen.info_rows["firmware"].isVisibleTo(screen.info_group))
        self.assertEqual("—", screen.info_labels["firmware"].text())
