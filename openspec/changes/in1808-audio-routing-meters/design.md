...
Audio-mode metadata acquisition SHALL issue the documented read-only `1# Design: IN1808 audio routing meters
...
2. a current Program-source indicator from mandatory `1# Design: IN1808 audio routing meters
...
- mandatory read-only `1# Design: IN1808 audio routing meters
...
- preservation of exact wire identity/variant without relabeling canonical
  `Extron IN1808`;
 Program-source binding with `1..9` / UNKNOWN normalization;
