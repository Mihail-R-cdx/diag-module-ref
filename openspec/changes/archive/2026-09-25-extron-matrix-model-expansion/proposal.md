...
- Retire XTP/XTP II from unified production registration and inventory dispatch in this change. Their exact identity/topology research may be reused only by a future separately reviewed change that explicitly restores them to production scope.
