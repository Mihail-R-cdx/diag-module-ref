...
- All currently supported codec microphone LIVE meters — Huawei TE20, TE40, TE50, and CloudLink Bar 310 — use a nominal serialized `700 ms` completed-cycle scheduling target. This changes no protocol command or support matrix: Box 310 and Polycom remain unsupported, no in-flight sample overlaps, and unrelated timers/lifecycles remain unchanged.
