...
```powershell
C:\Users\admin\AppData\Local\Programs\Python\Python312\python.exe .\tools\te20_http_toggle\toggle_te20_http.py --host link.ru --username admin --mode enable
```
...
```powershell
C:\Users\admin\AppData\Local\Programs\Python\Python312\python.exe .\tools\te20_http_toggle\toggle_te20_http.py --host link.ru --username admin --mode disable
```
