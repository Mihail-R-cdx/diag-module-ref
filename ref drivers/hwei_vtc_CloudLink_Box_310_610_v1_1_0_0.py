...
#        layoutViewList = [ImageStates[i] for i in qualifier['Images']]
    ...
    def SetSIPAddress(self, value, qualifier):
        ...
        data = {"CfgItemInt":[], "CfgItemString":[{"CfgItemID":ValueStateValues[value], "CfgItemInfo":'link.ru'}], "acCSRFToken": self.acCSRFToken}
...
class HTTPClass(DeviceClass):
    def __init__(self, ipAddress, port, deviceUsername='admin', devicePassword='admin', Model=None, SSLVerifyMode='On'):
