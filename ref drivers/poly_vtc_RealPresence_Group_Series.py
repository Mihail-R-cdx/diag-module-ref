...
class DeviceClass:
    ...
    def SetMicMute(self, value, qualifier):
        ...
        if value in ['On', 'Off']:
            self.__SetHelper('MicMute', 'mute near {}\r'.format(value.lower()), value, qualifier)
        else:
            self.Discard('Invalid Command for SetMicMute')

    def UpdateMicMute(self, value, qualifier):
        self.__UpdateHelper('MicMute', 'mute register\rmute near get\r', qualifier)
    ...
    def SetPresentation(self, value, qualifier):
        ...
        if value == 'Start':
            self.__SetHelper('Presentation', 'vcbutton play 2\r'.format(value), value, qualifier)
        if value in self.VideoContentSourceValues:
            self.__SetHelper('Presentation', 'vcbutton play {}\r'.format(value), value, qualifier)
        elif value == 'Stop':
            self.__SetHelper('Presentation', 'vcbutton stop\r', value, qualifier)
        else:
            self.Discard('Invalid Command for SetPresentation')

    def UpdatePresentation(self, value, qualifier):
        self.__UpdateHelper('Presentation', 'vcbutton source get\r', qualifier)
    ...
    def SetCameraMute(self, value, qualifier):
        ...
        if value in ['On', 'Off']:
            self.__SetHelper('CameraMute', 'videomute near {}\r'.format(value.lower()), value, qualifier)
        else:
            self.Discard('Invalid Command for SetCameraMute')

    def UpdateCameraMute(self, value, qualifier):
        self.__UpdateHelper('CameraMute', 'videomute near get\r', qualifier)
    ...
    def __ReceiveData(self, interface, data):
        ...
        try:
            self.NewStatus('Log', '{}'.format(data), None)
        except:
            pass
